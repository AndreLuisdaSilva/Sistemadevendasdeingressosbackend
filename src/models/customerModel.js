...
class CustomerModel {
    ...
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const db = (_a = options === null || options === void 0 ? void 0 : options.connection) !== null && _a !== void 0 ? _a : Databases_1.Database.getInstance();
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options === null || options === void 0 ? void 0 : options.user) {
                customer.user = new userModel_1.UserModel({
                    id: rows[0].user_id,
